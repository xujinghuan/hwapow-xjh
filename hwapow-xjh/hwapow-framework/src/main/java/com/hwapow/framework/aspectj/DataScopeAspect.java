...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.hwapow.common.annotation.DataScope)")
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            else if (DATA_SCOPE_CUSTOM.equals(dataScope))
            {
                if(StringUtils.isNotBlank(orgAlias)){
                    ...
                    sqlString.append(StringUtils.format(
                            " OR org_id IN ( SELECT org_id FROM sys_role_org WHERE role_id = {} ) ",
                            role.getRoleId()));
                }
            }
            else if (DATA_SCOPE_ORG.equals(dataScope))
            {
                if(StringUtils.isNotBlank(orgAlias)){
                    ...
                    sqlString.append(StringUtils.format(" OR org_id = {} ", user.getOrgId()));
                }
            }
