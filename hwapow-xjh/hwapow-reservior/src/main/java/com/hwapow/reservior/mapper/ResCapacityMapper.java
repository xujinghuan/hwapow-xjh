...
/**
 * 库容，主要管理水库水位线对应的库容值，方便取值Mapper接口
 * 
 * @author hwapow
 * @date 2021-09-18
 */
public interface ResCapacityMapper 
{
    /**
     ...
     * @return
     */
    public ResCapacity checkCapacityUnique(@Param("waterLevel") Double waterLevel, @Param("orgId")Long orgId);
}
