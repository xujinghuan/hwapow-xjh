  ...
  <el-container class="fullContainer">
    <el-header style="height: auto;">
      <el-form class="searchForm" size="mini" :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
        <el-form-item label="断面编码" prop="code">
          <el-input
    ...
    <div class="toolbar">
      <el-button
        ...
        size="mini"
        @click="handleAdd"
        v-hasPermi="['reservior:section:add']"
      >新增
      </el-button>
      <el-button
        type="success"
        ...
        :disabled="single"
        @click="handleUpdate"
        v-hasPermi="['reservior:section:edit']"
      >修改
      </el-button>
      <el-button
        type="danger"
        ...
        :disabled="multiple"
        @click="handleDelete"
        v-hasPermi="['reservior:section:remove']"
      >删除
      </el-button>
      <el-button
        type="warning"
        ...
        size="mini"
        @click="handleExport"
        v-hasPermi="['reservior:section:export']"
      >导出
      </el-button>
    ...
    <el-main>
      <el-table v-loading="loading" :data="sectionList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="断面编码" align="center" prop="code"/>
      ...
      <el-container class="fullContainer" direction="vertical">
        ...
        <el-main>
          <el-form size="mini" ref="form" :model="form" :rules="rules" label-width="80px">
            <el-form-item label="断面编码" prop="code">
              <el-input v-model="form.code" placeholder="请输入断面编码"/>
            </el-form-item>
            <el-form-item label="断面名称" prop="name">
              <el-input v-model="form.name" placeholder="请输入断面名称"/>
            </el-form-item>
...
<script>
import {listSection, getSection, delSection, addSection, updateSection, exportSection} from "@/api/reservior/section";
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有水库断面数据项?', "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(function () {
