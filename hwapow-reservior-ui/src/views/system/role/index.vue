<template>
  <el-container class="fullContainer">
    <el-header style="height: auto;">
      <el-form class="searchForm" size="mini" :model="queryParams" ref="queryForm" v-show="showSearch" :inline="true">
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="openDataScope"  width="500px" append-to-body>
      <el-container class="fullContainer" direction="vertical" style="height: 450px;">
        <div class="toolbar">
        ...
        <el-main>
          <el-form :model="form" label-width="80px">
            ...
            <el-form-item label="数据权限" v-show="form.dataScope == 2">
              <el-checkbox v-model="orgExpand" @change="handleCheckedTreeExpand($event, 'org')">展开/折叠</el-checkbox>
              <el-checkbox v-model="orgNodeAll" @change="handleCheckedTreeNodeAll($event, 'org')">全选/全不选</el-checkbox>
              <el-checkbox v-model="form.orgCheckStrictly" @change="handleCheckedTreeConnect($event, 'org')">父子联动</el-checkbox>
              <el-tree
                class="tree-border"
                :data="orgOptions"
                show-checkbox
