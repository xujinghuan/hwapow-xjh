<template>
  <el-container class="fullContainer">
    <el-header style="height: auto;">
      <el-form class="searchForm"  :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="上级菜单">
                  <treeselect class="vue-treeselect-mini"
              ...
              <el-col :span="12" v-if="form.menuType == 'C'">
                <el-form-item label="组件参数" prop="props">
                  <el-input v-model="form.props" placeholder="请输入组件参数" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
