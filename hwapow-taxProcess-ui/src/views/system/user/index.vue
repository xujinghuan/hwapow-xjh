<template>
  <el-container class="fullContainer">
    ...
    <el-main>
        <el-container class="fullContainer">
          <el-header style="height: auto;">
            <el-form class="searchForm" size="mini" :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
          ...
          <el-main>
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="组织" align="center" key="orgName" prop="org.orgName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="归属组织" prop="orgId">
                  <treeselect class="vue-treeselect-mini" v-model="form.orgId" :options="orgOptions" :show-count="true" placeholder="请选择归属组织" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, exportUser, resetUserPwd, resetUserPwdBatch,changeUserStatus, importTemplate } from "@/api/system/user";
  ...
  methods: {
    ...
    handleResetPwdBatch(){
      this.$prompt('请输入新密码', "提示", {
        ...
        resetUserPwdBatch(value).then(response => {
